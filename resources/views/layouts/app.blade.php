...
<head>
    ...
    <title>Aston events portal</title>

    <!-- Styles -->
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
</head>
@if(Session::has('likes') == false)
...
<body>
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top">
			...
			<li><a href="{{ route('list') }}">All events</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id=navbarDropdown href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true" v-pre>
